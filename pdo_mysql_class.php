...
contained any rows.
*/
	public function has_rows($result_set){
...
$result_set = a result set returned by either query_prepared() or query() functions passed by reference.
*/
...
$result_set = a result set returned by either query_prepared() or query() functions.
*/
	public function field_names($result_set){
		if($this->num_rows($result_set))
